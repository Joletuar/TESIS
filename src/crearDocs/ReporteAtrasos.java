...
//información de atrasos de los empleados.
...
public class ReporteAtrasos {
    ...
    private final int anio, mes; //Valor entero del mes elegido
    private int total_atrasos = 0; //Total de atrasos de la unidad

    private final ArrayList<MapeoDatos> empleados_atrasos = new ArrayList<>(); //Lista con los empleados que tienen atrasos  >= 1
    ...
    private MapeoDatos empleado_atrasado; //Objeto que almacena al empleado con más atrasos en el mes

    public ReporteAtrasos(String unidad, int mes, int anio, ArrayList<Empleado> empleados, ArrayList<Registro> registros) {

        int temp_atrasos = 0; //Variable que almacena de manera temporal el total de atrasos por cada empleado
        ...
        if (!empleados.isEmpty()) {
            ...
            for (Empleado empleado : empleados) {
                ...
                if (empleado.id_unidad == this.unidad.id_unidad && empleado.estatus.equals("ACTIVO")) {
                    ...
                    //Verificación de que el usuario presente registros y que tenga tambien atrasos
                    if (mapeo_empleado.bandera && mapeo_empleado.atrasos_total > 0) {

                        this.empleados_atrasos.add(mapeo_empleado);

                        //Condición y proceso para el elección del empleado con más atrasos en el mes
                        if (mapeo_empleado.atrasos_total > temp_atrasos) {

                            temp_atrasos = mapeo_empleado.atrasos_total;
                            this.empleado_atrasado = mapeo_empleado;
    ...
    public void GenerarReporte() {
        ...
        try {
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                PdfWriter.getInstance(reporte, new FileOutputStream(ruta + "/REPORTE DE ATRASOS-"
                ...
                titulo_2.add("REGISTRO DE ATRASOS DEL MES - " + MapeoDatos.StrMes(this.mes) + " - " + this.anio);
                ...
                if (!this.empleados_atrasos.isEmpty()) {
                    ...
                    //Iteración de los empleados con atrasos de la Lista de empleados atrasados
                    //Insercción de todos los datos necesarios en cada columna de la tabla
                    for (MapeoDatos mapeo : this.empleados_atrasos) {
                        ...
                        c4.add(String.valueOf(mapeo.atrasos_total));

                        this.total_atrasos += mapeo.atrasos_total;
                    ...
                    col11.add("MEDIA DE ATRASOS EN EL MES");

                    Paragraph col12 = new Paragraph();
                    col12.getFont().setSize(10);
                    col12.add(String.valueOf((float) (this.total_atrasos) / (float) (this.empleados_atrasos.size())));

                    Paragraph col21 = new Paragraph();
                    col21.add("EMPLEADO CON MÁS ATRASOS");

                    Paragraph col22 = new Paragraph();
                    col22.getFont().setSize(10);
                    col22.add(this.empleado_atrasado.empleado_seleccionado.apellidos + " " + this.empleado_atrasado.empleado_seleccionado.nombres);
                    ...
                    col32.add(String.valueOf(this.empleado_atrasado.atrasos_total));
