...
public class ReporteMes {
    ...
    public ReporteMes(String cedula, int mes, int anio, ArrayList<Registro> registros) {
    ...
    public void GenerarReporte() {
        ...
        try {
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                jornada_c.append(espaciado_2 + mapeo.hora_entrada.toString() + " - " + mapeo.hora_salida.toString());
                ...
                titulo_2.add("REGISTRO DE ASISTENCIAS DEL MES - " + mapeo.str_mes.trim() + " - " + mapeo.anio_seleccionado);
                ...
                if (mapeo.bandera) {
                    ...
                    PdfPTable registros_tabla = new PdfPTable(4);
                    ...
                    for (Registro registro : mapeo.registros_empleado) {
                        ...
                        LocalTime horas_al_dia = MapeoDatos.CalcularHorasTrabajadas(registro.hora_entrada, registro.hora_salida);
                        ...
                        //salida.
                        if (MapeoDatos.ConversionHora(registro.hora_salida) != null) {

                            if (MapeoDatos.ConversionHora(registro.hora_salida).isBefore(mapeo.hora_salida)) {

                                c3.setFont(font5);
                                c3.add(registro.hora_salida);
