...
import crearDocs.ReporteFaltas;
 ...
 * @author Johan Tuarez
 */
public class SeleccionFechaFaltas extends javax.swing.JFrame {
    ...
    public SeleccionFechaFaltas(ArrayList<Empleado> empleados, ArrayList<Registro> registros) {
    ...
    private void boton_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarActionPerformed
        ...
        if (!this.unidad_selccionada.equals("---SELECCIONAR---")) {
            ...
            ReporteFaltas reporte_faltas = new ReporteFaltas(this.unidad_selccionada, this.mes, this.anio, this.empleados, this.registros);
            reporte_faltas.GenerarReporte();
            this.dispose();
