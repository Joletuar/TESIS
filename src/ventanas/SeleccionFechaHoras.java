 ...
 * @author Johan Tuarez
 */
public class SeleccionFechaHoras extends javax.swing.JFrame {
    ...
    public SeleccionFechaHoras(ArrayList<Empleado> empleados, ArrayList<Registro> registros) {
    ...
    private void boton_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarActionPerformed
        ...
        if (!this.unidad_selccionada.equals("---SELECCIONAR---")) {
            ...
            ReporteHoras reporte_horas = new ReporteHoras(this.anio, this.mes, this.unidad_selccionada, this.empleados, this.registros);
            reporte_horas.GenerarReporte();
            this.dispose();
