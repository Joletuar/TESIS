...
import graficas.GraficaBarrasEmpleado;
import graficas.GraficaLineaEmpleado;
import graficas.GraficaPastelEmpleado;
 ...
 * @author Johan Tuarez
 */
public class SeleccionFechaGraficaEmpleado extends javax.swing.JFrame {
    ...
    public SeleccionFechaGraficaEmpleado(String cedula, ArrayList<Registro> registros, String tipo) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (this.tipo.equals("2D")) {
            ...
            GraficaPastelEmpleado grafica_1 = new GraficaPastelEmpleado(this.cedula, this.mes, this.anio, this.registros);
            GraficaBarrasEmpleado grafica_2 = new GraficaBarrasEmpleado(this.cedula, this.mes, this.anio, this.registros);
            GraficaLineaEmpleado grafica_3 = new GraficaLineaEmpleado(this.cedula, this.mes, this.anio, this.registros);

            grafica_1.Graficar2D();
            grafica_2.Graficar2D();
            grafica_3.Graficar2D();
