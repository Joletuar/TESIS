...
import crearDocs.ReporteAtrasos;
 ...
 * @author Johan Tuarez
 */
public class SeleccionFechaAtrasos extends javax.swing.JFrame {
    ...
    public SeleccionFechaAtrasos(ArrayList<Empleado> empleados, ArrayList<Registro> registros) {
    ...
    private void boton_aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_aceptarActionPerformed
        ...
        if (!this.unidad_selccionada.equals("---SELECCIONAR---")) {
            ...
            ReporteAtrasos reporte_atrasos = new ReporteAtrasos(this.unidad_selccionada, this.mes, this.anio, this.empleados, this.registros);
            reporte_atrasos.GenerarReporte();
            this.dispose();
